  ...
  <div class="module-root">
    ...
    <section class="kpi-summary-grid">
      <div class="kpi-card kpi-blue">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            ...
            <span class="kpi-mini-tag tag-blue">Corporate</span>
          </div>
      ...
      <div class="kpi-card kpi-purple">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-purple">{{ contactPersonCount }}</span>
            <span class="kpi-mini-tag tag-purple">Contacts</span>
          </div>
      ...
      <div class="kpi-card kpi-emerald">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-emerald">{{ citiesCount }}</span>
            <span class="kpi-mini-tag tag-emerald">Regions</span>
          </div>
      ...
      <div class="kpi-card kpi-amber">
        <div class="kpi-icon-glow icon-amber">
          <svg width="22" height="22" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2.2"><path stroke-linecap="round" stroke-linejoin="round" d="M7 7h.01M7 3h5a1 1 0 01.707.293l7 7a1 1 0 010 1.414l-5 5a1 1 0 01-1.414 0l-7-7A1 1 0 016 9V4a1 1 0 011-1z"/></svg>
        </div>
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-amber">{{ taxIdCount }}</span>
            <span class="kpi-mini-tag tag-amber">Tax ID</span>
          </div>
