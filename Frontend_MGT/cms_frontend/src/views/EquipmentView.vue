  ...
  <div class="module-root">
    ...
    <section class="kpi-summary-grid">
      <div class="kpi-card kpi-amber">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-amber">{{ items.length }}</span>
            <span class="kpi-mini-tag tag-amber">Total</span>
          </div>
      ...
      <div class="kpi-card kpi-blue">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-blue">{{ inUseCount }}</span>
            <span class="kpi-mini-tag tag-blue">In Field</span>
          </div>
      ...
      <div class="kpi-card kpi-emerald">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-emerald">{{ availableCount }}</span>
            <span class="kpi-mini-tag tag-emerald">Ready</span>
          </div>
      ...
      <div class="kpi-card kpi-purple">
        ...
        <div class="kpi-info">
          <div class="kpi-num-row">
            <span class="kpi-num color-purple">{{ maintenanceCount }}</span>
            <span class="kpi-mini-tag tag-purple">Service</span>
          </div>
